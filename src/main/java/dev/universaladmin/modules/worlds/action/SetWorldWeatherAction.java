...
public final class SetWorldWeatherAction implements Action<SetWorldWeatherInput, Void> {

    public static final ActionId ID = WorldActionIds.SET_WEATHER;

    private final TaskScheduler scheduler;

    public SetWorldWeatherAction(TaskScheduler scheduler) {
    ...
    @Override
    public CompletableFuture<ActionResult<Void>> execute(ActionContext context, SetWorldWeatherInput input) {
